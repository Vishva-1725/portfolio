...
export default function About() {
    ...
    return(
        <section className="flex flex-col md:flex-row secondary px-5 py-3" id='about'>
            ...
            <div className='md:w-1/2 flex justify-center pl-10'>
                <div className='flex flex-col justify-center'>
                    <h1 className='text-3xl text-white border-b-2  border-[#33cfd5]  w-[150px] font-fav'><span className='text-red-600'>A</span>bout <span className='text-red-600'>M</span>e</h1>
                    <p className='text-white text-[18px] py-5'>Hi, I am Vishva, I am Full Stack Web Developer.</p>
                    <p className='text-white text-[13px]'>I’m a passionate web developer with a strong foundation in front-end and back-end technologies. 
                      <br /><br />
