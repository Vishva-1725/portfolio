...
export default function Projects() {
    ...
    return(
        <section id='projects' className="flex flex-col px-5 py-10 justify-center primary text-white">
            <div className="w-full">
                <div className="flex flex-col px-10 py-5">
                   <h1 className='text-3xl text-white border-b-2 border-[#33cfd5] mb-5 w-[125px] font-fav'><span className="text-red-600">P</span>rojects</h1>
                   <p className='text-[15px]'>This are some of my best projects. I have built these with <span className='text-fav text-[#ee5c94]'>HTML, CSS, JAVASCRIPT and REACT JS</span>.
                    <br /> Check them out.</p>
                </div>  
            </div>
