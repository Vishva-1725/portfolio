...
export default function Hero() {
    ...
    return(<section className="flex flex-col md:flex-row px-5 py-20 primary justify-center">
       <div className='md:w-1/3 flex flex-col '>
            <h1 className=' text-white text-6xl font-fav'>Hi, <br /> Im <span className='text-red-700'>S</span> Vishva
            <p className='text-2xl '>{config.subtitle}</p>
            </h1>

            <div className='flex py-5'>
                <a target='_blank' href={config.social.twitter} className='pr-5 hover:text-green-400'><AiOutlineTwitter size={40}/></a>
                <a target='_blank' href={config.social.insta} className='pr-5 hover:text-red-600'><AiOutlineInstagram size={40}/></a>
                <a target='_blank' href={config.social.linkedin} className='hover:text-blue-900'><AiOutlineLinkedin size={40}/></a>
            </div>
        </div> 
